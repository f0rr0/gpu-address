...
import pytest
from gpu_postal.corpus import LATIN, address_type, audit_file, conflicts, inventory
from gpu_postal.expand import acquire, file_sha256, gnaf_row, hf_row
...
def test_landmark_relations_preserve_repeated_targets():
    from gpu_postal.expand import render
...
def test_inventory_pages_all_shards_and_records_missing_countries(tmp_path, monkeypatch):
    from gpu_postal.corpus import COUNTRY_CODES, TREE
